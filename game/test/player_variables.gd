...
var air_resistance : float = 0.9 #Controls air drag
...
var wall_running_angle_zone : float = PI/20 #Controls how much the angle can deviate from wall_running_angle_threshold to start wall running (radians)
